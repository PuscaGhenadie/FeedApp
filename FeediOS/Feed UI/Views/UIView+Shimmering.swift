...
extension UIView {
    public var isShimmering: Bool {
        set {
         ...
         get {
             return layer.mask?.animation(forKey: shimmeringAnimatonKey) != nil
         }
    }
    
    private var shimmeringAnimatonKey: String { "shimmer" }
    ...
    private func startShimmering() {
        ...
        gradient.add(animation, forKey: shimmeringAnimatonKey)
    }
